...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Invalid":     {appartifact.ErrInvalid, fault.InvalidArgument, fault.Client, "DM-APPARTIFACT-INVALID"},
		"Unsupported": {appartifact.ErrUnsupported, fault.InvalidArgument, fault.Client, "DM-APPARTIFACT-UNSUPPORTED"},
		"Limit":       {appartifact.ErrLimit, fault.PayloadTooLarge, fault.Client, "DM-APPARTIFACT-TOO-LARGE"},
	} {
