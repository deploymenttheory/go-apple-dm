...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Credential":    {contentcache.ErrCredential, fault.Unauthenticated, fault.Device, ""},
		"InvalidReport": {contentcache.ErrInvalidReport, fault.InvalidArgument, fault.Device, ""},
		"Config":        {contentcache.ErrConfig, fault.Internal, fault.Operator, ""},
	} {
