...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Parse":     {jose.ErrParse, fault.InvalidArgument, fault.Device, ""},
		"Algorithm": {jose.ErrAlgorithm, fault.InvalidArgument, fault.Device, ""},
		"Signature": {jose.ErrSignature, fault.PermissionDenied, fault.Device, ""},
		"Key":       {jose.ErrKey, fault.InvalidArgument, fault.Device, ""},
		"Header":    {jose.ErrHeader, fault.InvalidArgument, fault.Device, ""},
	} {
