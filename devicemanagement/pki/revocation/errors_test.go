...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Unknown": {revocation.ErrUnknown, fault.NotFound, fault.Client, "DM-PKI-ISSUER-UNKNOWN"},
		"Revoked": {revocation.ErrRevoked, fault.Conflict, fault.Client, "DM-PKI-CERTIFICATE-REVOKED"},
		"Expired": {revocation.ErrExpired, fault.PermissionDenied, fault.Client, "DM-PKI-CERTIFICATE-EXPIRED"},
		"Invalid": {revocation.ErrInvalid, fault.InvalidArgument, fault.Client, "DM-PKI-REVOCATION-INVALID"},
	} {
