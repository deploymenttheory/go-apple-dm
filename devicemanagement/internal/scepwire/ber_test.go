...
func TestEnvelopeBERBoundsAndFraming(t *testing.T) {
	for _, raw := range [][]byte{
		nil, {0x30}, {0, 0}, {0x04, 0x80, 0, 0}, // no indefinite primitive values
		{0x30, 0x80}, {0x30, 0x80, 0}, {0x30, 0x02, 0, 0}, // missing or misplaced EOC
		{0x30, 0x81}, {0x30, 0x85, 0, 0, 0, 0, 0}, {0x30, 0x81, 0xff},
		{0x30, 0x03, 0x02, 0x02, 0}, {0x30, 0x01, 0x04}, // child crosses enclosing length
		{0x1f}, {0x1f, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0},
	...
	for _, raw := range [][]byte{
		{0x30, 0}, {0x30, 0x80, 0, 0}, {0x30, 0x81, 0},
