...
// pinned here alongside a historical release input for older-device
// contracts. Generating this package from those inputs derives the wire
// types, validation, and support metadata from Apple's schema (decision
