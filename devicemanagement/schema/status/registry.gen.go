...
const (
	...
	// StatusItemTypeContentCacheInfo: Status Content Cache Info
	StatusItemTypeContentCacheInfo = "content-cache.info"
	// StatusItemTypeContentCacheParents: Status Content Cache Parents
	StatusItemTypeContentCacheParents = "content-cache.parents"
	// StatusItemTypeContentCachePeers: Status Content Cache Peers
	StatusItemTypeContentCachePeers = "content-cache.peers"
	// StatusItemTypeContentCacheStatus: Status Content Cache Status
	StatusItemTypeContentCacheStatus = "content-cache.status"
	...
	// StatusItemTypeDeviceSystemHealth: Status Device System Health
	StatusItemTypeDeviceSystemHealth = "device.system.health"
	...
	// StatusItemTypeEnhancedLoggingAppleCareToken: Status Enhanced Logging AppleCare Token
	StatusItemTypeEnhancedLoggingAppleCareToken = "enhanced-logging.applecare-token" // #nosec G101 -- Apple wire identifier, not a credential
	// StatusItemTypeEnhancedLoggingStatus: Status Enhanced Logging Status
	StatusItemTypeEnhancedLoggingStatus = "enhanced-logging.status"
	// StatusItemTypeEnhancedLoggingTimestamp: Status Enhanced Logging Timestamp
	StatusItemTypeEnhancedLoggingTimestamp = "enhanced-logging.timestamp"
	...
	// StatusItemTypeMDMEnrollmentType: Status MDM Enrollment Type
	StatusItemTypeMDMEnrollmentType = "mdm.enrollment-type"
	// StatusItemTypeMDMIsAwaitingConfiguration: Status MDM Is Awaiting Configuration
	StatusItemTypeMDMIsAwaitingConfiguration = "mdm.is-awaiting-configuration"
	// StatusItemTypeMDMIsReturnToService: Status MDM Is Return to Service
	StatusItemTypeMDMIsReturnToService = "mdm.is-return-to-service"
	// StatusItemTypeMDMIsSharedIPad: Status MDM Is Shared iPad
	StatusItemTypeMDMIsSharedIPad = "mdm.is-shared-ipad"
	// StatusItemTypeMDMPushMagic: Status MDM Push Magic
	StatusItemTypeMDMPushMagic = "mdm.push-magic"
	// StatusItemTypeMDMPushToken: Status MDM Push Token
	StatusItemTypeMDMPushToken = "mdm.push-token" // #nosec G101 -- Apple wire identifier, not a credential
	...
	// StatusItemTypeSecurityLockdownMode: Status Security Lockdown Mode
	StatusItemTypeSecurityLockdownMode = "security.lockdown-mode"
...
var Registry = map[string]Entry{
	...
	"ContentCacheInfo":                                  {ID: "content-cache.info", Schema: "declarative/status/content-cache.info.yaml", Title: "Status Content Cache Info", New: func() Item { return new(ContentCacheInfo) }},
	"ContentCacheParents":                               {ID: "content-cache.parents", Schema: "declarative/status/content-cache.parents.yaml", Title: "Status Content Cache Parents", New: func() Item { return new(ContentCacheParents) }},
	"ContentCachePeers":                                 {ID: "content-cache.peers", Schema: "declarative/status/content-cache.peers.yaml", Title: "Status Content Cache Peers", New: func() Item { return new(ContentCachePeers) }},
	"ContentCacheStatus":                                {ID: "content-cache.status", Schema: "declarative/status/content-cache.status.yaml", Title: "Status Content Cache Status", New: func() Item { return new(ContentCacheStatus) }},
	...
	"DeviceSystemHealth":                                {ID: "device.system.health", Schema: "declarative/status/device.system.health.yaml", Title: "Status Device System Health", New: func() Item { return new(DeviceSystemHealth) }},
	...
	"EnhancedLoggingAppleCareToken":                     {ID: "enhanced-logging.applecare-token", Schema: "declarative/status/enhanced-logging.applecare-token.yaml", Title: "Status Enhanced Logging AppleCare Token", New: func() Item { return new(EnhancedLoggingAppleCareToken) }},
	"EnhancedLoggingStatus":                             {ID: "enhanced-logging.status", Schema: "declarative/status/enhanced-logging.status.yaml", Title: "Status Enhanced Logging Status", New: func() Item { return new(EnhancedLoggingStatus) }},
	"EnhancedLoggingTimestamp":                          {ID: "enhanced-logging.timestamp", Schema: "declarative/status/enhanced-logging.timestamp.yaml", Title: "Status Enhanced Logging Timestamp", New: func() Item { return new(EnhancedLoggingTimestamp) }},
	"MDMApp":                                            {ID: "mdm.app", Schema: "declarative/status/mdm.app.yaml", Title: "Status MDM App", New: func() Item { return new(MDMApp) }},
	"MDMEnrollmentType":                                 {ID: "mdm.enrollment-type", Schema: "declarative/status/mdm.enrollment-type.yaml", Title: "Status MDM Enrollment Type", New: func() Item { return new(MDMEnrollmentType) }},
	"MDMIsAwaitingConfiguration":                        {ID: "mdm.is-awaiting-configuration", Schema: "declarative/status/mdm.is-awaiting-configuration.yaml", Title: "Status MDM Is Awaiting Configuration", New: func() Item { return new(MDMIsAwaitingConfiguration) }},
	"MDMIsReturnToService":                              {ID: "mdm.is-return-to-service", Schema: "declarative/status/mdm.is-return-to-service.yaml", Title: "Status MDM Is Return to Service", New: func() Item { return new(MDMIsReturnToService) }},
	"MDMIsSharedIPad":                                   {ID: "mdm.is-shared-ipad", Schema: "declarative/status/mdm.is-shared-ipad.yaml", Title: "Status MDM Is Shared iPad", New: func() Item { return new(MDMIsSharedIPad) }},
	"MDMPushMagic":                                      {ID: "mdm.push-magic", Schema: "declarative/status/mdm.push-magic.yaml", Title: "Status MDM Push Magic", New: func() Item { return new(MDMPushMagic) }},
	"MDMPushToken":                                      {ID: "mdm.push-token", Schema: "declarative/status/mdm.push-token.yaml", Title: "Status MDM Push Token", New: func() Item { return new(MDMPushToken) }},
	...
	"SecurityLockdownMode":                              {ID: "security.lockdown-mode", Schema: "declarative/status/security.lockdown-mode.yaml", Title: "Status Security Lockdown Mode", New: func() Item { return new(SecurityLockdownMode) }},
...
// StatusItemTypeName returns "content-cache.info".
func (*ContentCacheInfo) StatusItemTypeName() string { return "content-cache.info" }

// StatusItemTypeName returns "content-cache.parents".
func (*ContentCacheParents) StatusItemTypeName() string { return "content-cache.parents" }

// StatusItemTypeName returns "content-cache.peers".
func (*ContentCachePeers) StatusItemTypeName() string { return "content-cache.peers" }

// StatusItemTypeName returns "content-cache.status".
func (*ContentCacheStatus) StatusItemTypeName() string { return "content-cache.status" }
...
// StatusItemTypeName returns "device.system.health".
func (*DeviceSystemHealth) StatusItemTypeName() string { return "device.system.health" }
...
// StatusItemTypeName returns "enhanced-logging.applecare-token".
func (*EnhancedLoggingAppleCareToken) StatusItemTypeName() string {
	return "enhanced-logging.applecare-token"
}

// StatusItemTypeName returns "enhanced-logging.status".
func (*EnhancedLoggingStatus) StatusItemTypeName() string { return "enhanced-logging.status" }

// StatusItemTypeName returns "enhanced-logging.timestamp".
func (*EnhancedLoggingTimestamp) StatusItemTypeName() string { return "enhanced-logging.timestamp" }
...
// StatusItemTypeName returns "mdm.enrollment-type".
func (*MDMEnrollmentType) StatusItemTypeName() string { return "mdm.enrollment-type" }

// StatusItemTypeName returns "mdm.is-awaiting-configuration".
func (*MDMIsAwaitingConfiguration) StatusItemTypeName() string {
	return "mdm.is-awaiting-configuration"
}

// StatusItemTypeName returns "mdm.is-return-to-service".
func (*MDMIsReturnToService) StatusItemTypeName() string { return "mdm.is-return-to-service" }

// StatusItemTypeName returns "mdm.is-shared-ipad".
func (*MDMIsSharedIPad) StatusItemTypeName() string { return "mdm.is-shared-ipad" }

// StatusItemTypeName returns "mdm.push-magic".
func (*MDMPushMagic) StatusItemTypeName() string { return "mdm.push-magic" }

// StatusItemTypeName returns "mdm.push-token".
func (*MDMPushToken) StatusItemTypeName() string { return "mdm.push-token" }
...
// StatusItemTypeName returns "security.lockdown-mode".
func (*SecurityLockdownMode) StatusItemTypeName() string { return "security.lockdown-mode" }
