...
type NetworkVPNAlwaysOnTunnelConfigurationsIKEV2Authentication struct {
	...
	// to `Certificate`.
	IdentityAssetReference *string `plist:"IdentityAssetReference,omitempty" json:"IdentityAssetReference,omitempty"`
	// Specifies details about extended authentication (EAP).
...
// about extended authentication (EAP).
...
// NetworkVPNIKEV2AuthenticationExtendedAuth: Specifies details about extended authentication
// (EAP).
