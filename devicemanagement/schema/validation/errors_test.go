...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Validation": {validation.ErrValidation, fault.InvalidArgument, fault.Client, "DM-SCHEMA-INVALID"},
		"Errors":     {validation.Errors{{Path: "a", Rule: "required", Message: "x"}}, fault.InvalidArgument, fault.Client, "DM-SCHEMA-INVALID"},
	} {
