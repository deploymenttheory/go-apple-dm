...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Syntax":      {predicate.ErrSyntax, fault.InvalidArgument, fault.Client, "DM-PREDICATE-MALFORMED"},
		"Unsupported": {predicate.ErrUnsupported, fault.InvalidArgument, fault.Client, "DM-PREDICATE-UNSUPPORTED"},
		"Type":        {predicate.ErrType, fault.InvalidArgument, fault.Client, "DM-PREDICATE-TYPE-MISMATCH"},
	} {
