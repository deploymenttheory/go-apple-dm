...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"Invalid": {profile.ErrInvalid, fault.InvalidArgument, fault.Client, "DM-PROFILE-INVALID"},
		"Parse":   {profile.ErrParse, fault.InvalidArgument, fault.Client, "DM-PROFILE-MALFORMED"},
	} {
