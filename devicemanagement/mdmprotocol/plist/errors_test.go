...
func TestErrorsClassify(t *testing.T) {
	for name, tc := range map[string]struct {
		...
		"TooLarge":      {plist.ErrTooLarge, fault.PayloadTooLarge, fault.Client, "DM-PLIST-TOO-LARGE"},
		"TooDeep":       {plist.ErrTooDeep, fault.InvalidArgument, fault.Client, "DM-PLIST-TOO-DEEP"},
		"UnknownFormat": {plist.ErrUnknownFormat, fault.InvalidArgument, fault.Client, "DM-PLIST-UNKNOWN-FORMAT"},
	} {
