...
func Catalogue() []Scenario {
	return []Scenario{
		...
		},
		{
			...
			Family: "replacement",
			Modes:  []string{"simulated"},
			Run:    replacementScenario("scep", false),
		},
		{
			ID:     "E2E-029",
			...
			Family: "replacement",
			Modes:  []string{"simulated"},
			Run:    replacementScenario("scep", true),
		},
		{
			ID:       "E2E-030",
			...
			Modes:    []string{"simulated"},
			Settings: map[string]string{"DM_IDENTITY": "acme"},
			Run:      replacementScenario("acme", false),
		},
		{
			ID:       "E2E-031",
			...
			Modes:    []string{"simulated"},
			Settings: map[string]string{"DM_IDENTITY": "acme"},
			Run:      replacementScenario("acme", true),
		},
		{
			ID:     "APP-001",
