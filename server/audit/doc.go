...
// true with server/eventsink, which decides what an event may say. This package is
...
//
// What is stored is the projection from server/eventsink, never event.Data. The
