...
// authorizeLab uses the same first-root handoff as a normal deployment.
func (e *Environment) authorizeLab(ctx context.Context) error {
	...
	// An explicit policy, retained for review, authorizes the lab.s modules.
