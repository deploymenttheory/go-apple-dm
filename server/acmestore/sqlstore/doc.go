...
// records outlive the process. It reuses server/storage/sqlcommon's dialects and
...
// a keyring to protect, so Options carries none and the server/storage/crypt
