...
// record 0015, claim 4).
// target builds a push target, as apns's own tests do; this file exercises
// the APNs client against a store-backed certificate source, so it lives
// beside the store rather than beside the client.
