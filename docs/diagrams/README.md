...
| [package-layering](https://htmlpreview.github.io/?https://raw.githubusercontent.com/deploymenttheory/go-apple-dm/main/docs/diagrams/package-layering.html) | Import direction across the package graph, and the deliberate non-dependencies that keep it acyclic |
...
| [reference-server](https://htmlpreview.github.io/?https://raw.githubusercontent.com/deploymenttheory/go-apple-dm/main/docs/diagrams/reference-server.html) | workflow | How `internal/app` builds and serves, and what fails at build rather than at runtime |
