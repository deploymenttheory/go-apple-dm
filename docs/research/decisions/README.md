...
| [0035](0035-mdmctl-structure-and-credentials.md) | `mdmctl` structure, output, and credential handling | accepted | 8 |
| [0036](0036-mdmctl-explain-over-schema-support.md) | `mdmctl explain` over `schema/support` | accepted | 8 |
