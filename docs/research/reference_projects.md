...
| [Device management schema](../../third_party/apple-device-management/current/) | Pinned machine-readable wire definitions; provenance in `devicemanagement/schema/GENERATED_FROM.json` |
